...
// Syria Governorates, Districts, and Areas data
const SYRIA_LOCATIONS: Record<string, Record<string, string[]>> = {
    'دمشق': {
        'مركز دمشق': ['الحمراء', 'الصالحية', 'الشعلان', 'الملكي', 'العدوي', 'الحميدية', 'باب توما', 'باب شرقي', 'الميدان', 'القصاع']
    },
    'ريف دمشق': {
        'مركز ريف دمشق': ['الحسينية', 'جرمانا', 'النبك', 'القطيفة', 'يبرود', 'الزبداني', 'سرغايا', 'العربية', 'الرحيبة', 'عدرا'],
        'الغوطة الشرقية': ['دوما', 'حرستا', 'المليحة', 'سقبا', 'كفر بطنا', 'حزة', 'عربين', 'النشابية'],
        'الغوطة الغربية': ['الزبداني', 'الهامة', 'بقين', 'عين الفيجة', 'دير قانون', 'كفر سوسة']
    },
    'حلب': {
        'مركز حلب': ['الأعظمية', 'السكري', 'الصالحين', 'الليرمون', 'الحمدانية', 'الشهباء', 'الزهراء', 'النقطة', 'الشيخ مقصود', 'العزيزية'],
        'ريف حلب': ['منبج', 'السفيرة', 'اعزاز', 'الباب', 'جرابلس', 'دير حافر', 'الأتارب', 'تادف', 'الراعي', 'أخترين']
    },
    'حمص': {
        'مركز حمص': ['الوعر', 'الكرامة', 'الخالدية', 'الحضارة', 'الفروات', 'النزهة', 'الأندلس', 'العباسية', 'المهاجرين', 'الطيران'],
        'ريف حمص': ['الرستن', 'تدمر', 'المخرم', 'القصير', 'الحولة', 'تلكلخ', 'الحصن', 'فيروزة', 'العشة', 'الدوير']
    },
    'اللاذقية': {
        'مركز اللاذقية': ['الصليبة', 'المشروع', 'القضيبي', 'الشبطة', 'الحي الجنوبي', 'الحي الشمالي', 'سيدي علي', 'الهرمل', 'البستان', 'الفوطة'],
        'ريف اللاذقية': ['الحفة', 'جبلة', 'الدالية', 'شطحة', 'عين الشرقية', 'عين شقاق', 'البهلولية', 'بشراغي', 'الفاخورة', 'كسب']
    },
    'حماة': {
        'مركز حماة': ['الحاضر', 'المرابط', 'الجسر', 'الكرامة', 'المنتزه', 'الوحدة', 'الناصرة', 'الأندلس', 'السلطانية', 'الفلاحة'],
        'ريف حماة': ['محردة', 'السقيلبية', 'مصياف', 'سلمية', 'تلبيسة', 'الرastن', 'كفرزيتا', 'اللطامنة', 'عقيربات', 'جب رملة']
    },
    'طرطوس': {
        'مركز طرطوس': ['الحيدرية', 'الديماس', 'الرمل الشمالي', 'الرمل الجنوبي', 'الجبلية', 'الكراج', 'الوادي', 'البعث', 'السلام', 'الكورنيش'],
        'ريف طرطوس': ['الدريكيش', 'صافيتا', 'الشيخ بدر', 'القطيلبية', 'بانياس', 'رأس الخشوفة', 'العوينة', 'الحميدية', 'البحصة', 'بستان الديك']
    },
    'الرقة': {
        'مركز الرقة': ['المرور', 'الفردوس', 'الصناعة', 'النزهة', 'الكوثر', 'السلام', 'الرشيد', 'الطيار', 'الحزام', 'الجمعية'],
        'ريف الرقة': ['الطبقة', 'دير الزور', 'السور', 'عين عيسى', 'تل السمن', 'السلحبية', 'المنصورة', 'الجزرة', 'المشلب', 'الهادي']
    },
    'دير الزور': {
        'مركز دير الزور': ['الحميدية', 'الجبيلة', 'العمال', 'الشهداء', 'المطار', 'القصور', 'الرشدية', 'المزهب', 'العزيز', 'الطيارة'],
        'ريف دير الزور': ['الميادين', 'البوكمال', 'الحسينية', 'الشعيطات', 'الصالحية', 'العشارة', 'الكريم', 'المحيمدة', 'الهري', 'حطلة']
    },
    'السويداء': {
        'مركز السويداء': ['الشهيد', 'العظمة', 'العقلة', 'الوحدة', 'الناصرة', 'الجبيل', 'الفاخورة', 'الصالحية', 'الجزيرة', 'الحارة'],
        'ريف السويداء': ['شهبا', 'صلخد', 'قنوات', 'الغيضة', 'الجبيل', 'المزرعة', 'الهش', 'القرية', 'الكوم', 'الصورة']
    },
    'الحسكة': {
        'مركز الحسكة': ['الشهداء', 'الأربعين', 'الناصرة', 'الشرطة', 'الوحدة', 'الكرامة', 'الجزيرة', 'المطار', 'الصالحية', 'الخضراء'],
        'ريف الحسكة': ['القامشلي', 'ديرك', 'المالكية', 'الشدادي', 'تل حميس', 'الحسكة', 'العريشة', 'الهول', 'الرميلان', 'أبو راسين']
    },
    'درعا': {
        'مركز درعا': ['السحاري', 'الجامع', 'القصور', 'النزهة', 'الصالحية', 'الحامية', 'الحارة', 'الكشكول', 'المحطة', 'الجديدة'],
        'ريف درعا': ['الصنمين', 'إزرع', 'الحrak', 'بصرى الشام', 'نوى', 'طفس', 'جاسم', 'صيدا', 'المسيفرة', 'الشجر']
    },
    'إدلب': {
        'مركز إدلب': ['الجامع', 'السوق', 'الشهداء', 'النزهة', 'القصور', 'الحارة', 'الحامية', 'الجديدة', 'الصالحية', 'الوحدة'],
        'ريف إدلب': ['معرة النعمان', 'جسر الشغور', 'أريحا', 'سراقب', 'الدانا', 'بنش', 'كفر نبل', 'الحس', 'سرمين', 'تفتناز']
    },
    'القنيطرة': {
        'مركز القنيطرة': ['الشهيد', 'الجزيرة', 'الوحدة', 'الناصرة', 'الصالحية', 'الجديدة', 'الحارة', 'السوق', 'الجامع', 'الحامية'],
        'ريف القنيطرة': ['الخضر', 'جبا', 'الرفيد', 'الهنية', 'الصباحية', 'العجم', 'الشيخ سعد', 'الطنطورة', 'الزبيدي', 'القرية']
    }
};
