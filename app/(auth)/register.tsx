...
const SYRIA_CITIES = [
    ...
    'الرقة', 'دير الزور', 'السويداء', 'الحسكة', 'درعا',
...
export default function RegisterScreen() {
    ...
    const handleRegister = async () => {
        if (!form.first_name || !form.last_name || !form.phone || !form.password || !form.city) {
            ...
            <ScrollView style={styles.container} bounces={false} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.form}>
                        ...
                        >
                            <MaterialCommunityIcons name="city-variant-outline" size={20} color="#9CA3AF" style={styles.inputIcon} />
                            <Text style={[styles.input, !form.city && { color: '#9CA3AF' }]}>
                                {form.city || 'المدينة'}
                            </Text>
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        <View style={styles.modalHeader}>
                            ...
                            <TouchableOpacity onPress={() => setCityModalVisible(false)} style={styles.closeBtn}>
