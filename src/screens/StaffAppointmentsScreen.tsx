...
type StaffAppointmentsScreenProps = {
    ...
    consultationReportPath?: string;
    showConsultationActions?: boolean;
    headerTitle?: string;
};
...
export default function StaffAppointmentsScreen({
    ...
    const loadData = async () => {
        ...
        try {
            const apts = await api.getAppointments({ doctor_id: doctorId });
                                ...
                                <View style={styles.actions}>
                                    {showConsultationActions ? (
                                        <TouchableOpacity
                                            ...
                                            onPress={() => router.push({
                                                pathname: consultationReportPath,
                                                params: {
